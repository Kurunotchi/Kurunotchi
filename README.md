...
I specialize in bridging physical and digital engineering disciplines—developing 3D models, CAD designs, and embedded systems solutions. Based in Palawan, Philippines, my work integrates hardware, software, and industrial design to address real-world challenges, with a focus on environmental monitoring and sustainable technology.
...
*Developing engineering solutions while mentoring the next generation of electronics and computer engineers in Palawan.*
...
<details>
<summary><b>View Competition Details</b></summary>

<br>

### 🤖 Battlebots Competition 2024 — Champion
- **Chassis:** Polycarbonate structure, designed in Fusion 360
- **Drive System:** High-torque motors with precision control
- **Sensors:** IR-based opponent detection
- **Record:** Undefeated throughout the competition

### 🎨 3D Design Competition 2025 — 3rd Place
- **Software:** Blender, Fusion 360
- **Focus:** Complex organic modeling and print optimization
- **Features:** Functional articulated components
...
*Widgets update automatically and reflect live GitHub activity.*
...
- 🌊 **Multi-Parameter Sensing** — Continuous real-time monitoring of four critical water quality indicators
- 🔋 **Solar-Powered Operation** — Engineered for remote coastal deployment without grid dependency
- 🖨️ **Integrated Mechanical Design** — Waterproof enclosure and mounting hardware modeled in Fusion 360
- 📊 **Cloud-Based Dashboard** — Historical data logging and trend visualization

*This project represents a commitment to applying engineering for environmental protection and public safety in Palawan.*
...
I document engineering projects and share technical insights on YouTube.
...
- **Portfolio:** [kurunotchi.vercel.app](https://kurunotchi.vercel.app/)

---

> *"Design it. Engineer it. Build it. Teach it." — Palawan, Philippines.*
